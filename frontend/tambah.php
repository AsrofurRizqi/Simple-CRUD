...
<form method="post">
    <div class="row mb-3">
        ...
        <div class="col-sm-8">
            <input class="form-control" type="text" name="merek" required></br>
        </div>
    </div>
    <div class="row mb-3">
        <div class="col-sm-4 col-form-label">Nomor Seri</div>
        <div class="col-sm-8">
            <input class="form-control" type="text" name="serial" required></br>
        </div>
    </div>
    <div class="row mb-3">
        <div class="col-sm-4 col-form-label">Tahun Produksi</div>
        <div class="col-sm-8">
            <input class="form-control" type="text" name="tahun" required></br>
        </div>
    </div>
...
if(isset($_POST['merek']) and !empty($_POST['merek'])) {
    $sql = "insert into laptop(merek, serial, tahun_produksi) values('" .
        $_POST['merek'] . "','" . $_POST['serial'] . "','" . $_POST['tahun'] . "')";
